...
public class FrotaService {
    ...
    public FrotaService(Scanner scanner) {
        ...
        while (it.hasNext()) {
            ...
            if (carro.getMatricula().equals(matricula)) {
                ...
                if (carro.isEmManutencao()) {
                    System.out.println("Não é possível remover um carro que está em manutenção.");
                    return;
                }
                it.remove();
                guardarCarros();
    ...
    public void concluirManutencao() {
        ...
        System.out.println("Aviso: carro da manutenção não encontrado na frota.");
    }
