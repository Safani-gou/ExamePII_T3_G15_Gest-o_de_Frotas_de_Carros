public class Carro {
    ...
    public String toFileString() {
        return matricula + ";" + marca + ";" + modelo + ";" + ano + ";" + disponivel + ";" + emManutencao + ";" + clienteBi;
    }
    public static Carro fromFileString(String linha) {
        ...
        c.setEmManutencao(partes.length > 5 ? Boolean.parseBoolean(partes[5].trim()) : false);
        c.setClienteBi(partes.length > 6 ? partes[6].trim() : "");
        return c;
    }
